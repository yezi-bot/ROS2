...
#include "example_ros2_interface/msg/detail/robot_pose__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_example_ros2_interface
...
using _RobotPose__ros_msg_type = example_ros2_interface__msg__RobotPose;
...
size_t get_serialized_size_example_ros2_interface__msg__RobotPose(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotPose__ros_msg_type * ros_message = static_cast<const _RobotPose__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RobotPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_example_ros2_interface__msg__RobotPose(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_example_ros2_interface
size_t max_serialized_size_example_ros2_interface__msg__RobotPose(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = example_ros2_interface__msg__RobotPose;
    is_plain =
      (
...
static size_t _RobotPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_example_ros2_interface__msg__RobotPose(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, example_ros2_interface, msg, RobotPose)() {
